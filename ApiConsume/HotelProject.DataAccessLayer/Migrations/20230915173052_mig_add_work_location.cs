...
{
    public partial class mig_add_work_location : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WorkLocationName = table.Column<string>(nullable: true),
                    WorkLocationCity = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
